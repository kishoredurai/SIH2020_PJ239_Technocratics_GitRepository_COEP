    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (num_.isEmpty() || sendto_.isEmpty())
                    Toast.makeText(MainActivity.this, "Enter your mobile number and Email address", Toast.LENGTH_SHORT).show();
                else {
                    sendMail();
                    try {
                        String apiKey = "apikey=" + "01fQksa03dM-dYAkSbU4TpHoiuV5fO8uSsrHjT7cnq";
                        ...
                        //Toast.makeText(MainActivity.this, "OTP unable to send through sms", Toast.LENGTH_SHORT).show();
                    }
