    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    try {
                        String apiKey = "apikey=" + "ymMYKXtVPp4-ydlVPR77us1iJhN8UVebm1ONHRifEN";
                        ...
                        Toast.makeText(MainActivity.this,"Connect to a network to recieve OTP", Toast.LENGTH_SHORT).show();
                    }
